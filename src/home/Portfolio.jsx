...
import Portfolio3 from '../assets/porfolio/portfolio-3.png'
        ...
        <section id="portfolio" className="max-w-[1160px] w-full mx-auto mt-[168px]  px-[24px] lg:px-0 ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-4 mt-[51px]">
                <div className="grid gap-4" >
                    <a href="https://project-5-social-media-application.vercel.app/" target="_blank" className="overflow-hidden rounded-lg" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div data-aos="fade-up" data-aos-duration="1500" className="grid gap-4">
                    <a href="https://project-4-employee-management-dashboard.vercel.app/" target="_blank" className="overflow-hidden rounded-lg" data-aos="fade-up" data-aos-duration="1000">
                        <img className="h-full w-full max-w-full object-cover transform hover:scale-150 transition-all duration-[600ms]" 
                        src={Portfolio2} alt="" />
                    </a>
                </div>
